...
import com.tuga.konum.util.lerp
import com.tuga.konum.view.material.BottomNavDrawerFragment.SandwichState.CLOSED
import com.tuga.konum.view.material.BottomNavDrawerFragment.SandwichState.OPEN
import com.tuga.konum.view.material.BottomNavDrawerFragment.SandwichState.SETTLING
...
class BottomNavDrawerFragment :
  ...
  private var sandwichState: SandwichState = CLOSED
...
//      }
  ...
  fun toggle() {
    when {
      sandwichState == OPEN -> toggleSandwich()
