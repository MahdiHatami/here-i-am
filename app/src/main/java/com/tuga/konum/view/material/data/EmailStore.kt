...
package com.tuga.konum.view.material.data

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import com.tuga.konum.R.drawable
...
object EmailStore {
    ...
    private val allEmails = mutableListOf(
        ...
        Email(
            ...
            listOf(
                EmailAttachment(drawable.paris_1, "Bridge in Paris"),
                EmailAttachment(drawable.paris_2, "Bridge in Paris at night"),
                EmailAttachment(drawable.paris_3, "City street in Paris"),
                EmailAttachment(drawable.paris_4, "Street with bike in Paris")
            ),
            true
        ),
        Email(
